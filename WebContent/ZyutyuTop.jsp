...
<link rel="stylesheet" href="remodal-default-theme.css">
  ...
  String list[] = (String[])session.getAttribute("list1");

  String tbl=list[0];
  String tbl2=list[1];
  String tbl3=list[2];//list[2];
      ...
      <main class="mdl-layout__content mdl-color--grey-100">
        <div class="col-sm-12">
          <ul class="mui-tabs__bar">
            ...
            <li><a data-mui-toggle="tab" data-mui-controls="pane-default-3">定期購入リスト</a></li>
          </ul>
              ...
              <nav>
               ...
               <ul>
                 ...
                 <table class="table">
                      ...
                      <thead>
                        <tr>
                          <th class="col-sm-1">注文番号</th>
                          <th class="col-sm-2">会員名</th>
          ...
          <div class="cnter-block">
            <div class="table-responsive col-sm-6 col-sm-offset-1">
              <nav>
                <ul class="pagination">
                  <li class="disabled tb_back3">
                    <a href="#" aria-label="前のページへ">
                      <span aria-hidden="true">«</span>
                    </a>
                  </li>
                  <li class="active tb_index3"><a href="#">1</a></li>
                  <li class="tb_index3"><a href="#">2</a></li>
                  <li class="tb_index3"><a href="#">3</a></li>
                  <li class="tb_index3"><a href="#">4</a></li>
                  <li class="tb_index3"><a href="#">5</a></li>
                  <li class="tb_prev3">
                    <a href="#" aria-label="次のページへ">
                      <span aria-hidden="true">»</span>
                    </a>
               ...
               <ul>
                 <li class="tb_page3 tb_active3">
                 <table class="table">

                      <thead>
                        <tr>
                          <th class="col-sm-1">会員番号</th>
                          <th class="col-sm-2">会員名</th>
                          <th class="col-sm-3">注文日</th>
                        </tr>
                      </thead>
  ...
  <div id="test2" class='remodal' data-remodal-id='modal2' data-remodal-options='hashTracking:false' style='border-radius:20px;'>

		<div class="h2">
			注文完了してもよろしいですか？
		</div>		<button data-remodal-action='cancel' class='remodal-cancel'>Cancel</button>
		<button data-remodal-action='confirm' class='remodal-confirm tekityumon'>OK</button>
