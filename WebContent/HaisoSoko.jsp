...
<link rel="stylesheet" href="remodal-default-theme.css">
  ...
  String hairetu[] = (String[])session.getAttribute("haitatsu");
  String sokoname = (String)session.getAttribute("sokomei");
  String tbl=hairetu[0];
  String tbl2=hairetu[1];
  if(tbl==null){tbl="";}
  if(tbl2==null){tbl2="";}
  ...
  %>
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        <div class="mdl-layout__header-row">
          <span class="mdl-layout-title">配送管理><%=sokoname %></span>
      ...
      <main class="mdl-layout__content mdl-color--grey-100">
        <div class="col-sm-12">
          <ul class="mui-tabs__bar">
            <li class="mui--is-active"><a data-mui-toggle="tab" data-mui-controls="pane-default-1">未配送リスト</a></li>
            <li><a data-mui-toggle="tab" data-mui-controls="pane-default-2">配達伝票生成一覧</a></li>
          </ul>
          ...
          <div class="mui-tabs__pane" id="pane-default-2">
            ...
            <div class="table-responsive col-sm-9 col-sm-offset-0.5">
              <nav>
               ...
               <ul>
                 <li class="tb_page2 tb_active2">
                   <section id="Sokopage2">
                      <%=tbl2 %>
                    </section>
                 </li>
                 <li class="tb_page2">
    ...
    <div id="test" class='remodal' data-remodal-id='modal' data-remodal-options='hashTracking:false'>
    ...
    <div id="test2" class='remodal' data-remodal-id='modal' data-remodal-options='hashTracking:false'>
		<div class="h2">
			配送完了してもよろしいですか？
		</div>
		<button data-remodal-action='cancel' class='remodal-cancel'>Cancel</button>
		<button data-remodal-action='confirm' class='remodal-confirm complete'>OK</button>


	  </div>
	  <div id="haitatuStart" class='remodal' data-remodal-id='modal2' data-remodal-options='hashTracking:false'>
		<div class="h2">
			配送開始してもよろしいですか？
		</div>
		<button data-remodal-action='cancel' class='remodal-cancel'>Cancel</button>
		<button data-remodal-action='confirm' class='remodal-confirm delistart'>OK</button>
