...
<%
 ...
 String tbl = (String)session.getAttribute("Teki");
  ...
  <div class='row'>
    <div class='col-md-3 '>
      <div class='list-group'>
        <a class="list-group-item" href="mypage.jsp"><i class="material-icons">account_circle</i>MYPAGE</a>
        ...
        <a class="list-group-item disabled" href="TekiTopServlet"><i class="material-icons">shopping_basket</i>定期購入一覧</a>
...
<table class='table'>
  <thead>
    <tr>
      <th class='col-md-7 col-xs-7'>商品名</th>
      <th class='col-md-1 col-xs-1'>個数</th>
      <th class='col-md-2 col-xs-2'>購入間隔</th>
      <th class='col-md-1 col-xs-1'>次回購入日</th>
    </tr>
  </thead>
  <tbody>
    <%=tbl %>
