...
String tbl = (String)session.getAttribute("carttbl");
...
<a class="navbar-brand" href="index.jsp">
    ...
    <div class="collapse navbar-collapse" id="navbarEexample">
     ...
     <form class='navbar-form navbar-left' role='search' action='ProductsSearch' method='POST'>
      ...
      <p class="navbar-text navbar-right"><a href="#" class="navbar-link"><i class="material-icons">history</i>購入履歴</a></p>

      <p class="navbar-text navbar-right"><a href="#" class="navbar-link"><i class="material-icons">shopping_cart</i>カート</a></p>

      <p class="navbar-text navbar-right"><a href="#" class="navbar-link"><i class="material-icons">account_circle</i>マイページ</a></p>
...
<div class="list-group">
  <a class="list-group-item" href="#"><i class="material-icons">account_circle</i>MYPAGE</a>
  <a class="list-group-item disabled" href="CartKanriServlet?hantei=2"><i class="material-icons">shopping_cart</i>カート</a>
...
<div id="kounyubottun">
  ...
  <button type="submit" class="btn btn-info btn-lg" id="konyu"><i class="material-icons">enhanced_encryption</i>購入する</button>
  </form>
...
<!-- /footer -->
 ...
 <script language="javascript">
  ...
  if(a=="￥0"){
    // 無効化
    document.getElementById("konyu").disabled = "true";
    console.log("ボタン無効");
  }else{
    console.log("ボタン有効");
  }
