...
<%
 ...
 String hislist = (String)session.getAttribute("hislist");
...
<div class="list-group">
  ...
  <a class="list-group-item disabled" href="HistoryKanriServlet"><i class="material-icons">history</i>購入履歴</a>
...
<table class="table table-hover">
  <thead>
    <tr>
      <th class="col-xs-1 col-ms-1">商品No</th>
      <th class="col-xs-3 col-ms-3">商品名</th>
      <th class="col-xs-1 col-ms-1">個数</th>
      <th class="col-xs-4 col-ms-4">購入金額</th>
      <th class="col-xs-2 col-ms-2">注文日</th>
      <th class="col-xs-1 col-ms-1">注文状況</th>
    </tr>
  </thead>
  <tbody>
